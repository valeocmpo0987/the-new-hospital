...
if (isset($_POST['cerrar_sesion'])) {
    ...
    header("Location: /consultorio/conmed/index.html");
    exit();
}
?>
<!DOCTYPE html>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            // Verifica si el usuario ha iniciado sesión y muestra el botón de cierre de sesión
                            if (isset($_SESSION['usuario'])) {
                                echo '<form method="POST" action="">
                                        <button type="submit" name="cerrar_sesion" class="btn btn-link nav-link">Cerrar sesión</button>
                                      </form>';
                            }
                            ?>
                        </li>
